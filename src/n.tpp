...
typename GenericUrn<T, ORDER, REPETITION>::GenericUrn(uint k, const std::vector<T>& elements):m_urn {static_cast<uint>(elements.size()),k}, 
                                                                                     m_elements {elements}{}
...
//Iterator 
template<typename T, bool ORDER, bool REPETITION>
typename GenericUrn<T, ORDER, REPETITION>::Iterator::Iterator(const GenericUrn<T,ORDER,REPETITION>* urn, const uint& ordinalnumber, const Status& status): m_itUrn{ urn },
                                                                                                      m_ordinalnumber{ static_cast<int>(ordinalnumber) },
                                                                                                      m_status { status }{}

template<typename T, bool ORDER, bool REPETITION>
typename GenericUrn<T, ORDER, REPETITION>::Iterator::Iterator() = default;
...
template<typename T, bool ORDER, bool REPETITION>
const value_type GenericUrn<T,ORDER,REPETITION>::Iterator::operator*() const 
{   
...
template<typename T, bool ORDER, bool REPETITION>
typename GenericUrn<T,ORDER,REPETITION>::Iterator operator+(const difference_type& n, const GenericUrn<T,ORDER,REPETITION>::Iterator& other) 
{
    return other + n;
}
