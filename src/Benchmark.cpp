...
#ifdef MEMORY_BENCHMARK_ENABLED
int main()
{   
    /****************************************************
    *                                                  *
    ...
    ****************************************************/
    ...
    int randomDrawUrnOR = distr(gen);
        ...
        for(auto i: draws.at(randomDrawUrnOR)){}
        sleep(1); //Damit cmdbench genung Zeit zum messen hat
...
#endif //MEMORY_BENCHMARK_ENABLED